...
The command is inspired by the original [nwcommands](https://github.com/THOMASGRUND/NWCOMMANDS) suite. Algorithms have been tuned to match outputs generated by Python's [networkx](https://networkx.org/en/) package to the extent possible.
